...
ExternalProject_Add_Step(
	...
	DEPENDEES configure
	DEPENDERS build
	COMMAND ${CMAKE_COMMAND} -E echo "Running:  ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}"  ${EXPAT_SETTINGS} ${FMILIB_THIRDPARTYLIBS}/Expat/expat-2.0.1"
	COMMAND ${CMAKE_COMMAND} -G "${CMAKE_GENERATOR}" ${EXPAT_SETTINGS} "${FMILIB_THIRDPARTYLIBS}/Expat/expat-2.0.1"
