...
MACRO(MERGE_STATIC_LIBS TARGET OUTPUT_NAME LIBS_TO_MERGE)
  ...
  FOREACH(LIB ${LIBS_TO_MERGE})
    ...
    if(MSVC)
		foreach(CONFIG_TYPE ${CONFIGURATION_TYPES})
			GET_TARGET_PROPERTY("LIB_LOCATION_${CONFIG_TYPE}" ${LIB} "LOCATION_${CONFIG_TYPE}")
			SET(LIB_LOCATION ${LIB_LOCATION} ${LIB_LOCATION_${CONFIG_TYPE}})
		endforeach()
	else()
    ...
    ELSE()
      ...
      IF(LIB_TYPE STREQUAL "STATIC_LIBRARY")
		if(MSVC)
			foreach(CONFIG_TYPE ${CONFIGURATION_TYPES})
				SET(STATIC_LIBS_${CONFIG_TYPE} ${STATIC_LIBS_${CONFIG_TYPE}} ${LIB_LOCATION_${CONFIG_TYPE}})
				SET(STATIC_LIBS ${STATIC_LIBS} ${STATIC_LIBS_${CONFIG_TYPE}})
			endforeach()
		else()
  ...
  IF(MSVC)
	...
	foreach(CONFIG_TYPE ${CONFIGURATION_TYPES})
		SET(LINKER_EXTRA_FLAGS_${CONFIG_TYPE} "")
		FOREACH(LIB ${STATIC_LIBS_${CONFIG_TYPE}})
			SET(LINKER_EXTRA_FLAGS_${CONFIG_TYPE} "${LINKER_EXTRA_FLAGS_${CONFIG_TYPE}} ${LIB}")
			string(TOUPPER "STATIC_LIBRARY_FLAGS_${CONFIG_TYPE}" PROPNAME)
			SET_TARGET_PROPERTIES(${TARGET} PROPERTIES ${PROPNAME} "${LINKER_EXTRA_FLAGS_${CONFIG_TYPE}}")
		ENDFOREACH()
	endforeach()
...
MACRO(MERGE_LIBRARIES)
  ...
  message(STATUS "${TARGET} will merge: ${LIBS}")
