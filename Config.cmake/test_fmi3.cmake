...
set(XML_PATCH_VERSION_PATH ${FMU3_DUMMY_FOLDER}/modelDescription_patched.xml)
...
compress_fmu("${TEST_OUTPUT_FOLDER}" "BouncingBall3"           "patched" "fmu3_dll_cs" "${XML_PATCH_VERSION_PATH}" "${SHARED_LIBRARY_CS_PATH}" "${FMI3_PLATFORM}")
...
to_native_c_path("${TEST_OUTPUT_FOLDER}/BouncingBall3_patched.fmu" FMU3_PATCHED_PATH)
...
add_catch2_test(fmi3_import_error_handling_model_variables FMI3)
add_catch2_test(fmi3_import_error_handling_model_structure FMI3)
...
add_catch2_test(fmi3_import_version_test                   FMI3)
