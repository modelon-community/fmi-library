...
int main(int argc, char *argv[])
{
    ...
    fail_name_check("q-name/chinese"); /* this should pass in FMI 1.0 */

    /* der() tests */
    fail_name_check("der/dera32"); /* this should pass in FMI 1.0 */
    ...
    fail_name_check("array/a12345678space"); /* this should pass in FMI 1.0 */
    pass_name_check("array/a1.a3");
    pass_name_check("array/a.a123");
    fail_name_check("array/aspace1");
    fail_name_check("array/a1space");
    fail_name_check("array/a1space1"); /* this should pass in FMI 1.0 */
