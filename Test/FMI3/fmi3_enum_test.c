...
int test_default_valid_variablity()
{
    ...
    fmi3_variability_enu_t v;

    v = fmi3_get_default_valid_variability(fmi3_causality_enu_parameter);
    ASSERT_MSG(v == fmi3_variability_enu_fixed,
               "Default parameter variability should be fixed");

    v = fmi3_get_default_valid_variability(fmi3_causality_enu_calculated_parameter);
    ASSERT_MSG(v == fmi3_variability_enu_fixed,
               "Default calc param variability should be fixed");

    for (c = fmi3_causality_enu_input; c <= fmi3_causality_enu_unknown; c++) {
        v = fmi3_get_default_valid_variability(c);
        ASSERT_MSG(v == fmi3_variability_enu_continuous,
...
static int validate_initial(fmi3_causality_enu_t c,
                            fmi3_initial_enu_t expected[])
{
    size_t i;
    fmi3_variability_enu_t v = fmi3_variability_enu_constant;
    for (i = 0; i < N_VARIABILITIES; i++, v++) {
        fmi3_initial_enu_t initial = fmi3_get_default_initial(v, c);
        ASSERT_MSG(initial == expected[i], fmi3_variability_to_string(v));
    }
...
int test_default_initial_param()
{
    ...
    return validate_initial(fmi3_causality_enu_parameter, expected);
}
...
int test_default_initial_calc_param()
{
    ...
    return validate_initial(fmi3_causality_enu_calculated_parameter, expected);
}
...
int test_default_initial_input()
{
    ...
    return validate_initial(fmi3_causality_enu_input, expected);
}
...
int test_default_initial_output()
{
    ...
    return validate_initial(fmi3_causality_enu_output, expected);
}
...
int test_default_initial_independent()
{
    ...
    return validate_initial(fmi3_causality_enu_independent, expected);
}
...
int test_default_initial_unknown()
{
    ...
    return validate_initial(fmi3_causality_enu_unknown, expected);
}

int validate_variability_causality(fmi3_causality_enu_t c, int expected[])
{
    fmi3_variability_enu_t v = fmi3_variability_enu_constant;
    int i;

    for (i = 0; i < N_VARIABILITIES; i++, v++) {
        int is_valid = fmi3_is_valid_variability_causality(v, c);
        ASSERT_MSG(is_valid == expected[i], fmi3_variability_to_string(v));
    }
...
int test_valid_combination_param()
{
    ...
    return validate_variability_causality(fmi3_causality_enu_parameter, expected);
}

int test_valid_combination_calc_param()
{
    int expected[N_VARIABILITIES] = {0, 1, 1, 0, 0, 0};
    return validate_variability_causality(fmi3_causality_enu_calculated_parameter,
                                          expected);
}
...
int test_valid_combination_input()
{
    ...
    return validate_variability_causality(fmi3_causality_enu_input, expected);
}

int test_valid_combination_output()
{
    int expected[N_VARIABILITIES] = {1, 0, 0, 1, 1, 0};
    return validate_variability_causality(fmi3_causality_enu_output, expected);
}

int test_valid_combination_local()
{
    int expected[N_VARIABILITIES] = {1, 1, 1, 1, 1, 0};
    return validate_variability_causality(fmi3_causality_enu_local, expected);
}

int test_valid_combination_independent()
{
    int expected[N_VARIABILITIES] = {0, 0, 0, 0, 1, 0};
    return validate_variability_causality(fmi3_causality_enu_independent,
                                          expected);
}
...
int test_valid_combination_unknown()
{
    ...
    return validate_variability_causality(fmi3_causality_enu_unknown, expected);
}
