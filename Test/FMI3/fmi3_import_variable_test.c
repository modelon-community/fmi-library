...
static int enum_minimal_test(fmi3_import_t* xml)
{
    ...
    ASSERT_MSG(fmi3_import_get_variability(v) == fmi3_variability_enu_discrete,
               "Variability should be discrete");
    ASSERT_MSG(fmi3_import_get_initial(v) == fmi3_initial_enu_calculated,
    ...
    ASSERT_MSG(fmi3_import_get_enum_variable_max(ev) == 3, "Wrong enum max");
    ASSERT_MSG(fmi3_import_get_enum_variable_min(ev) == 1, "Wrong enum min");

    t = fmi3_import_get_variable_declared_type(v);
    ASSERT_MSG(t != NULL, "No declaredType found for enum variable");

    ASSERT_MSG(strcmp(fmi3_import_get_type_name(t), "MyEnum") == 0,
               "Wrong type name for enum");
    ASSERT_MSG(strcmp(fmi3_import_get_type_quantity(t), "TypeQuantity") == 0,
    ...
    ASSERT_MSG(fmi3_import_get_enum_type_max(et) == 3, "Wrong enum type max");
    ASSERT_MSG(fmi3_import_get_enum_type_min(et) == 1, "Wrong enum type min");
    ASSERT_MSG(fmi3_import_get_enum_type_size(et) == 3,
...
static int enum_maximal_test(fmi3_import_t* xml)
{
    ...
    ASSERT_MSG(strcmp(fmi3_import_get_variable_description(v), "myDescription") == 0,
               "Wrong description");
    ASSERT_MSG(fmi3_import_get_causality(v) == fmi3_causality_enu_output,
               "Causality should be output");
    ASSERT_MSG(fmi3_import_get_variability(v) == fmi3_variability_enu_discrete,
               "Variability should be discrete");
    ASSERT_MSG(fmi3_import_get_initial(v) == fmi3_initial_enu_exact,
               "Initial should be exact");

    ev = fmi3_import_get_variable_as_enum(v);
    ASSERT_MSG(ev != NULL, "Failed to convert to enum variable");
    ASSERT_MSG(fmi3_import_get_enum_variable_max(ev) == 2, "Wrong enum max");
    ASSERT_MSG(fmi3_import_get_enum_variable_min(ev) == 1, "Wrong enum min");
    ASSERT_MSG(fmi3_import_get_enum_variable_start(ev) == 2, "Wrong enum start");
