...
static jm_status_enu_t fmi3_capi_load_common_fcn(fmi3_capi_t* fmu, unsigned int capabilities[])
{
    ...
    LOAD_DLL_FUNCTION(fmi3InstantiateBasicCoSimulation);
    LOAD_DLL_FUNCTION(fmi3InstantiateHybridCoSimulation);
    LOAD_DLL_FUNCTION(fmi3InstantiateScheduledCoSimulation);
...
/* Load FMI 3.0 Basic CoSimulation functions */
static jm_status_enu_t fmi3_capi_load_bcs_fcn(fmi3_capi_t* fmu, unsigned int capabilities[])
{
	jm_status_enu_t jm_status = jm_status_success;
...
/* Load FMI 3.0 Hybrid CoSimulation functions */
static jm_status_enu_t fmi3_capi_load_hcs_fcn(fmi3_capi_t* fmu, unsigned int capabilities[])
{
	jm_status_enu_t jm_status = jm_status_success;
...
/* Load FMI 3.0 Scheduled CoSimulation functions */
static jm_status_enu_t fmi3_capi_load_scs_fcn(fmi3_capi_t* fmu, unsigned int capabilities[])
{
	jm_status_enu_t jm_status = jm_status_success;
...
jm_status_enu_t fmi3_capi_load_fcn(fmi3_capi_t* fmu, unsigned int capabilities[])
{
	...
	} else if (fmu->standard == fmi3_fmu_kind_bcs) {
		return fmi3_capi_load_bcs_fcn(fmu, capabilities);
	} else if (fmu->standard == fmi3_fmu_kind_hcs) {
		return fmi3_capi_load_hcs_fcn(fmu, capabilities);
	} else if (fmu->standard == fmi3_fmu_kind_scs) {
		return fmi3_capi_load_scs_fcn(fmu, capabilities);
...
{
    return fmu->inst = fmu->fmi3InstantiateBasicCoSimulation(
            instanceName,
            instantiationToken,
            resourceLocation,
            visible,
...
fmi3_instance_t fmi3_capi_instantiate_hybrid_co_simulation(
        ...
        fmi3_callback_intermediate_update_ft intermediateUpdate)
{
    return fmu->inst = fmu->fmi3InstantiateHybridCoSimulation(
            instanceName,
            instantiationToken,
            resourceLocation,
            visible,
...
{
    return fmu->inst = fmu->fmi3InstantiateScheduledCoSimulation(
            instanceName,
            instantiationToken,
            resourceLocation,
            visible,
...
fmi3_status_t fmi3_capi_enter_event_mode(
        fmi3_capi_t*       fmu,
        fmi3_boolean_t     input_event,
        fmi3_boolean_t     step_event,
        const fmi3_int32_t roots_found[],
        size_t             n_event_indicators,
        fmi3_boolean_t     time_event)
{
    assert(fmu); assert(fmu->inst);
    jm_log_verbose(fmu->callbacks, FMI_CAPI_MODULE_NAME, "Calling fmi3EnterEventMode");
    return fmu->fmi3EnterEventMode(fmu->inst, input_event, step_event, roots_found, n_event_indicators, time_event);
}
...
fmi3_status_t fmi3_capi_get_clock(
        ...
        size_t nValues)
{
	return fmu->fmi3GetClock(fmu->inst, valueReferences, nValueReferences, values, nValues);
}
...
fmi3_status_t fmi3_capi_set_clock(
        ...
        size_t nValues)
{
	return fmu->fmi3SetClock(fmu->inst, valueReferences, nValueReferences, values, subactive, nValues);
}
...
fmi3_status_t fmi3_capi_get_interval_decimal(
        ...
        size_t nValues)
{
	return fmu->fmi3GetIntervalDecimal(fmu->inst, valueReferences, nValueReferences, interval, nValues);
}
...
fmi3_status_t fmi3_capi_get_interval_fraction(
        ...
        size_t nValues)
{
	return fmu->fmi3GetIntervalFraction(fmu->inst, valueReferences, nValueReferences, intervalCounter, resolution,
            nValues);
}
...
fmi3_status_t fmi3_capi_set_interval_decimal(
        ...
        size_t nValues)
{
	return fmu->fmi3SetIntervalDecimal(fmu->inst, valueReferences, nValueReferences, interval, nValues);
}
...
fmi3_status_t fmi3_capi_set_interval_fraction(
        ...
        size_t nValues)
{
	return fmu->fmi3SetIntervalFraction(fmu->inst, valueReferences, nValueReferences, intervalCounter, resolution,
            nValues);
}
...
{
	return fmu->fmi3NewDiscreteStates(fmu->inst, newDiscreteStatesNeeded, terminateSimulation,
