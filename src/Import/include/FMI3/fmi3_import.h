...
*/
FMILIB_EXPORT size_t fmi3_import_get_number_of_continuous_states(fmi3_import_t* fmu);

/** \brief Get the number of event indicators. */
FMILIB_EXPORT size_t fmi3_import_get_number_of_event_indicators(fmi3_import_t* fmu);
