...
/**	\addtogroup fmi3_import_capi_const_destroy FMI 2.0 Constructor and Destructor	
 ...
 *
 * 	\addtogroup fmi3_import_capi_me FMI 2.0 (ME) Model Exchange functions
 * \brief List of Model Exchange wrapper functions. Common functions are not listed.
 *	\addtogroup fmi3_import_capi_cs FMI 2.0 (CS) Co-Simulation functions 
 * \brief List of Co-Simulation wrapper functions. Common functions are not listed.
 *	\addtogroup fmi3_import_capi_common FMI 2.0 (ME & CS) Common functions
 ...
 *           then the jm_callbacks:: and fmi3_log_forwarding are utitlized to fill in the default structure.
 * @return Error status. If the function returns with an error, it is not allowed to call any of the other C-API functions.
 */
FMILIB_EXPORT jm_status_enu_t fmi3_import_create_dllfmu(fmi3_import_t* fmu, fmi3_fmu_kind_enu_t fmuKind, const fmi3_callback_functions_t* callBackFunctions);
 ...
 */
FMILIB_EXPORT jm_status_enu_t fmi3_import_instantiate(fmi3_import_t* fmu,
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_enter_initialization_mode(fmi3_import_t* fmu);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_set_integer(fmi3_import_t* fmu, const fmi3_value_reference_t vr[], size_t nvr, const fmi3_integer_t value[]);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_set_boolean(fmi3_import_t* fmu, const fmi3_value_reference_t vr[], size_t nvr, const fmi3_boolean_t value[]);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_integer(fmi3_import_t* fmu, const fmi3_value_reference_t vr[], size_t nvr, fmi3_integer_t value[]);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_boolean(fmi3_import_t* fmu, const fmi3_value_reference_t vr[], size_t nvr, fmi3_boolean_t value[]);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_string(fmi3_import_t* fmu, const fmi3_value_reference_t vr[], size_t nvr, fmi3_string_t  value[]);
 ...
 */
FMILIB_EXPORT const char* fmi3_import_get_types_platform(fmi3_import_t* fmu);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_new_discrete_states(fmi3_import_t* fmu, fmi3_event_info_t* eventInfo);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_cancel_step(fmi3_import_t* fmu);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_status(fmi3_import_t* fmu, const fmi3_status_kind_t s, fmi3_status_t*  value);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_integer_status(fmi3_import_t* fmu, const fmi3_status_kind_t s, fmi3_integer_t* value);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_boolean_status(fmi3_import_t* fmu, const fmi3_status_kind_t s, fmi3_boolean_t* value);
 ...
 * @return FMI status.
 */
FMILIB_EXPORT fmi3_status_t fmi3_import_get_string_status(fmi3_import_t* fmu, const fmi3_status_kind_t s, fmi3_string_t*  value);
