...
FMILIB_EXPORT const char* fmi3_import_get_enum_item_name(fmi3_import_enumeration_typedef_t* td, size_t item);

/** \brief Get an enumeration item value by index */
FMILIB_EXPORT int fmi3_import_get_enum_item_value(fmi3_import_enumeration_typedef_t* td, size_t item);

/** \brief Get an enumeration item description by index */
FMILIB_EXPORT const char* fmi3_import_get_enum_item_description(fmi3_import_enumeration_typedef_t* td, size_t item);
