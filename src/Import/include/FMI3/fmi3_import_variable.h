...
/** \brief Get the size of the dimensions of an array variable
    @return Pointer to array of dimension sizes. Length of this array is given by
        #fmi3_import_variable_get_number_dimensions TODO: implement this func
*/
...
/** \brief Cast general variable to a one with the specific type 
	...
	@return Typed object or NULL if base type does not match
*/
FMILIB_EXPORT fmi3_import_integer_variable_t* fmi3_import_get_variable_as_integer(fmi3_import_variable_t*);
/** \brief Cast general variable to a one with the specific type 
...
/** \brief Get start value for the variable*/
FMILIB_EXPORT int fmi3_import_get_integer_variable_start(fmi3_import_integer_variable_t* v);
/** \brief Get minimal value for the variable */
FMILIB_EXPORT int fmi3_import_get_integer_variable_min(fmi3_import_integer_variable_t* v);
/** \brief Get max value for the variable */
FMILIB_EXPORT int fmi3_import_get_integer_variable_max(fmi3_import_integer_variable_t* v);
