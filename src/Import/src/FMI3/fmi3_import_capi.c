...
jm_status_enu_t fmi3_import_create_dllfmu(fmi3_import_t* fmu, fmi3_fmu_kind_enu_t fmuKind,
        const fmi3_instance_environment_t instanceEnvironment, const fmi3_callback_log_message_ft logMessage) {
	...
	fmi3_callback_log_message_ft logMessageFinal = logMessage;
	...
	else if(fmuKind == fmi3_fmu_kind_bcs)
		modelIdentifier = fmi3_import_get_model_identifier_CS(fmu);
	else if(fmuKind == fmi3_fmu_kind_hcs)
		modelIdentifier = fmi3_import_get_model_identifier_CS(fmu); /* TODO: change to _hcs */
	else if(fmuKind == fmi3_fmu_kind_scs)
		modelIdentifier = fmi3_import_get_model_identifier_CS(fmu); /* TODO: change to _scs */
	else {
		assert(0);
		return jm_status_error;
	}
                                                       ...
                                                       fmi3_boolean_t visible)
{
    ...
    fmi3_instance_t c;
    if (!resourceLocation) 
        resourceLocation = fmu->resourceLocation;
...
jm_status_enu_t fmi3_import_instantiate_basic_co_simulation(
        fmi3_import_t*                       fmu,
        fmi3_string_t                        instanceName,
        fmi3_string_t                        resourceLocation,
        fmi3_boolean_t                       visible,
        ...
        fmi3_callback_intermediate_update_ft intermediateUpdate)
{
    ...
    c = fmi3_capi_instantiate_basic_co_simulation(
           fmu->capi,
           instanceName,
           instantiationToken,
           resourceLocation,
...
jm_status_enu_t fmi3_import_instantiate_hybrid_co_simulation(
        fmi3_import_t*                       fmu,
        fmi3_string_t                        instanceName,
        fmi3_string_t                        resourceLocation,
        fmi3_boolean_t                       visible,
        ...
        fmi3_callback_intermediate_update_ft intermediateUpdate)
{
    ...
    c = fmi3_capi_instantiate_hybrid_co_simulation(
           fmu->capi,
           instanceName,
           instantiationToken,
           resourceLocation,
...
jm_status_enu_t fmi3_import_instantiate_scheduled_co_simulation(
        fmi3_import_t*                       fmu,
        fmi3_string_t                        instanceName,
        fmi3_string_t                        resourceLocation,
        fmi3_boolean_t                       visible,
        ...
        fmi3_callback_unlock_preemption_ft   unlockPreemption)
{
    ...
    c = fmi3_capi_instantiate_scheduled_co_simulation(
           fmu->capi,
           instanceName,
           instantiationToken,
           resourceLocation,
...
fmi3_status_t fmi3_import_enter_event_mode(
        fmi3_import_t*     fmu,
...
{
    return fmi3_capi_enter_event_mode(fmu->capi, input_event, step_event, roots_found, n_event_indicators, time_event);
}
...
fmi3_status_t fmi3_import_get_clock(
        ...
        size_t nValues)
{
	return fmi3_capi_get_clock(fmu->capi, valueReferences, nValueReferences, values, nValues);
}
...
fmi3_status_t fmi3_import_set_clock(
        ...
        size_t nValues)
{
	return fmi3_capi_set_clock(fmu->capi, valueReferences, nValueReferences, values, subactive, nValues);
}
...
fmi3_status_t fmi3_import_get_interval_decimal(
        ...
        size_t nValues)
{
	return fmi3_capi_get_interval_decimal(fmu->capi, valueReferences, nValueReferences, interval, nValues);
}
...
fmi3_status_t fmi3_import_get_interval_fraction(
        ...
        size_t nValues)
{
	return fmi3_capi_get_interval_fraction(fmu->capi, valueReferences, nValueReferences, intervalCounter, resolution, nValues);
}
...
fmi3_status_t fmi3_import_set_interval_decimal(
        ...
        size_t nValues)
{
	return fmi3_capi_set_interval_decimal(fmu->capi, valueReferences, nValueReferences, interval, nValues);
}
...
fmi3_status_t fmi3_import_set_interval_fraction(
        ...
        size_t nValues)
{
	return fmi3_capi_set_interval_fraction(fmu->capi, valueReferences, nValueReferences, intervalCounter, resolution, nValues);
}

fmi3_status_t fmi3_import_new_discrete_states(
        fmi3_import_t*  fmu,
...
{
	return fmi3_capi_new_discrete_states(fmu->capi, newDiscreteStatesNeeded, terminateSimulation,
...
{
    return fmi3_capi_activate_model_partition(fmu->capi, clockReference, clockElementIndex, activationTime);
}
