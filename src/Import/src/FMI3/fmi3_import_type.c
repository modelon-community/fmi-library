...
const char* fmi3_import_get_enum_item_name(fmi3_import_enumeration_typedef_t* t, unsigned int  item) {
    return fmi3_xml_get_enum_item_name(t, item);
}

const char* fmi3_import_get_enum_item_description(fmi3_import_enumeration_typedef_t* t, unsigned int  item){
    return fmi3_xml_get_enum_item_description(t, item);
}

int fmi3_import_get_enum_item_value(fmi3_import_enumeration_typedef_t* t, unsigned int  item) {
