...
#define gen_fmi3_import_get_TYPE_XX(XX, TYPE, TYPE_SIZE, TYPE_NO_SIGN)                                           \
    fmi3_##TYPE_SIZE##_t fmi3_import_get_##TYPE_SIZE##_type##XX(fmi3_import_##TYPE_NO_SIGN##_typedef_t* t) {     \
...
#define gen_all_fmi3_import_get_TYPE_XX_float(TYPE_SIZE)                        \
    gen_fmi3_import_get_TYPE_XX(_min,               float, TYPE_SIZE, float)    \
    gen_fmi3_import_get_TYPE_XX(_max,               float, TYPE_SIZE, float)    \
    gen_fmi3_import_get_TYPE_XX(_nominal,           float, TYPE_SIZE, float)    \
...
#define gen_all_fmi3_import_get_TYPE_XX_int(TYPE_SIZE)                      \
    gen_fmi3_import_get_TYPE_XX(_min,               int, TYPE_SIZE, int)    \
    gen_fmi3_import_get_TYPE_XX(_max,               int, TYPE_SIZE, int)

#define gen_all_fmi3_import_get_TYPE_XX_uint(TYPE_SIZE)                      \
    gen_fmi3_import_get_TYPE_XX(_min,               uint, TYPE_SIZE, int)    \
    gen_fmi3_import_get_TYPE_XX(_max,               uint, TYPE_SIZE, int)

gen_all_fmi3_import_get_TYPE_XX_int(int64)
gen_all_fmi3_import_get_TYPE_XX_int(int32)
gen_all_fmi3_import_get_TYPE_XX_int(int16)
gen_all_fmi3_import_get_TYPE_XX_int(int8)
gen_all_fmi3_import_get_TYPE_XX_uint(uint64)
gen_all_fmi3_import_get_TYPE_XX_uint(uint32)
gen_all_fmi3_import_get_TYPE_XX_uint(uint16)
gen_all_fmi3_import_get_TYPE_XX_uint(uint8)
