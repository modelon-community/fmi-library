...
const char* fmi2_xml_get_type_quantity(fmi2_xml_variable_typedef_t* t) {
    ...
    case fmi2_base_type_enum:
        ret = ((fmi2_xml_enum_type_props_t*)props)->quantity;
		break;
    default:
        return 0;
    }
...
int fmi2_xml_get_enum_type_min(fmi2_xml_enumeration_typedef_t* t){
    fmi2_xml_variable_typedef_t* vt = (void*)t;
    fmi2_xml_enum_type_props_t* props = (fmi2_xml_enum_type_props_t*)(vt->typeBase.baseTypeStruct);
    return props->typeMin;
}
...
void fmi2_xml_init_enumeration_type_properties(fmi2_xml_enum_type_props_t* type, jm_callbacks* cb) {
...
void fmi2_xml_free_enumeration_type_props(fmi2_xml_enum_type_props_t* type) {
...
void fmi2_xml_init_type_definitions(fmi2_xml_type_definitions_t* td, jm_callbacks* cb) {
    ...
    td->defaultRealType.typeBase.structKind = fmi2_xml_type_struct_enu_base;
    fmi2_xml_init_enumeration_type_properties(&td->defaultEnumType,cb);
    td->defaultEnumType.typeBase.structKind = fmi2_xml_type_struct_enu_base;
    fmi2_xml_init_integer_type_properties(&td->defaultIntegerType);
    td->defaultIntegerType.typeBase.structKind = fmi2_xml_type_struct_enu_base;

    fmi2_xml_init_variable_type_base(&td->defaultBooleanType, fmi2_xml_type_struct_enu_base,fmi2_base_type_bool);
    fmi2_xml_init_variable_type_base(&td->defaultStringType, fmi2_xml_type_struct_enu_base,fmi2_base_type_str);
...
void fmi2_xml_free_type_definitions_data(fmi2_xml_type_definitions_t* td) {
...

    {
        ...
        while(cur) {
            next = cur->next;
            if((cur->baseType == fmi2_base_type_enum) && (cur->structKind == fmi2_xml_type_struct_enu_props)) {
                fmi2_xml_enum_type_props_t* props = (fmi2_xml_enum_type_props_t*)cur;
...
int fmi2_xml_handle_Type(fmi2_xml_parser_context_t *context, const char* data) {
    if(!data) {
            ...
            /*  <xs:attribute name="name" type="xs:normalizedString" use="required"/> */
                fmi2_xml_set_attr_string(context, fmi2_xml_elmID_Type, fmi_attr_id_name, 1, bufName) ||
            /* <xs:attribute name="description" type="xs:string"/> */
                fmi2_xml_set_attr_string(context, fmi2_xml_elmID_Type, fmi_attr_id_description, 0, bufDescr)
                    ) return -1;
            named.ptr = 0;
			named.name = 0;
...
int fmi2_check_last_elem_is_specific_type(fmi2_xml_parser_context_t *context) {
    if (
                (context->lastElmID == fmi2_xml_elmID_RealType)  ||
                (context->lastElmID == fmi2_xml_elmID_IntegerType)  ||
                (context->lastElmID == fmi2_xml_elmID_BooleanType)  ||
                (context->lastElmID == fmi2_xml_elmID_StringType)  ||
                (context->lastElmID == fmi2_xml_elmID_EnumerationType)
                ) {
        fmi2_xml_parse_fatal(context, "Multiple definitions for a type are not allowed");
        return -1;
    }
    return 0;
}
...
/*        jm_vector(char)* bufName = fmi_get_parse_buffer(context,1);
    ...
    if(    /*    <xs:attribute name="relativeQuantity" type="xs:boolean" default="false"> */
            fmi2_xml_set_attr_boolean(context, elmID, fmi_attr_id_relativeQuantity, 0, &boolBuf, 0) ||
...
int fmi2_xml_handle_RealType(fmi2_xml_parser_context_t *context, const char* data) {
    if(!data) {
        ...
        fmi2_xml_real_type_props_t * props;
        if(fmi2_check_last_elem_is_specific_type(context)) return -1;
...
int fmi2_xml_handle_EnumerationType(fmi2_xml_parser_context_t *context, const char* data) {
    if(!data) {
        jm_named_ptr named;
        fmi2_xml_model_description_t* md = context->modelDescription;
        fmi2_xml_enum_type_props_t * props;
        fmi2_xml_variable_typedef_t* type;
        const char * quantity = 0;
        /*        jm_vector(char)* bufName = fmi_get_parse_buffer(context,1);
                jm_vector(char)* bufDescr = fmi_get_parse_buffer(context,2); */
        ...
        props = (fmi2_xml_enum_type_props_t*)fmi2_xml_alloc_variable_type_props(&md->typeDefinitions, &md->typeDefinitions.defaultEnumType.typeBase, sizeof(fmi2_xml_enum_type_props_t));
        ...
        if(
                /* <xs:attribute name="min" type="xs:int"/> */
                fmi2_xml_set_attr_int(context, fmi2_xml_elmID_EnumerationType, fmi_attr_id_min, 0,  &props->typeMin, 1) ||
                /* <xs:attribute name="max" type="xs:int"/> */
                fmi2_xml_set_attr_int(context, fmi2_xml_elmID_EnumerationType, fmi_attr_id_max, 0, &props->typeMax, INT_MAX)
                ) return -1;
        named = jm_vector_get_last(jm_named_ptr)(&context->modelDescription->typeDefinitions.typeDefinitions);
        type = named.ptr;
    ...
    if(!data) {
        {
            ...
            fmi2_xml_enum_type_props_t * enumProps = (fmi2_xml_enum_type_props_t*)md->typeDefinitions.typePropsList;
            fmi2_xml_enum_type_item_t * item;
            jm_named_ptr named, *pnamed;
            size_t descrlen;

            assert((enumProps->typeBase.structKind == fmi2_xml_type_struct_enu_props) && (enumProps->typeBase.baseType == fmi2_base_type_enum));
