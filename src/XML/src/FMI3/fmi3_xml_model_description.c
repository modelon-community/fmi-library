        ...
        fmi3_fmu_kind_enu_t fmuKind)
{
    ...
    if (fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(providesDirDerIdOld))) {
        fmi3_xml_parse_error(context,
    ...
    if (fmi3_xml_parse_attr_as_string(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_modelIdentifier), 1, modelIdentifierPtr)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_needsExecutionTool), 0,
                &md->capabilities[fmi3_me_needsExecutionTool + offset], 0)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_canBeInstantiatedOnlyOncePerProcess), 0,
                &md->capabilities[fmi3_me_canBeInstantiatedOnlyOncePerProcess + offset], 0)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_canGetAndSetFMUState), 0,
                &md->capabilities[fmi3_me_canGetAndSetFMUState + offset], 0)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_canSerializeFMUState), 0,
                &md->capabilities[fmi3_me_canSerializeFMUState + offset], 0)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(providesDirDerId), 0,
                &md->capabilities[fmi3_me_providesDirectionalDerivatives + offset], 0)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_providesAdjointDerivatives), 0,
                &md->capabilities[fmi3_me_providesAdjointDerivatives + offset], 0)
        ||
        fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_providesPerElementDependencies), 0,
...
int fmi3_xml_handle_ModelExchange(fmi3_xml_parser_context_t *context, const char* data) {
    ...
    if (!data) {
        ...
        if (fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_needsCompletedIntegratorStep), 0,
            ...
            ||
            fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_providesEvaluateDiscreteStates), 0,
...
int fmi3_xml_handle_CoSimulation(fmi3_xml_parser_context_t *context, const char* data) {
    ...
    if(!data) {
        ...
        if (fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_canHandleVariableCommunicationStepSize), 0,
            ...
            ||
            fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_providesIntermediateUpdate), 0,
                    &md->capabilities[fmi3_cs_providesIntermediateUpdate], 0)
            ||
            fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_mightReturnEarlyFromDoStep), 0,
                    &md->capabilities[fmi3_cs_mightReturnEarlyFromDoStep], 0)
            ||
            fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_canReturnEarlyAfterIntermediateUpdate), 0,
                    &md->capabilities[fmi3_cs_canReturnEarlyAfterIntermediateUpdate], 0)
            ||
            fmi3_xml_parse_attr_as_boolean(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_hasEventMode), 0,
        ...
        if (fmi3_xml_parse_attr_as_uint32(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_maxOutputDerivativeOrder), 0,
        ...
        if (fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_fixedInternalStepSize))) {
            md->coSimulation.hasFixedInternalStepSize = 1;
            if (fmi3_xml_parse_attr_as_float64(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_fixedInternalStepSize), 0,
                    &md->coSimulation.fixedInternalStepSize, 0))
            {
                return -1;
            }
        }
        if (fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_recommendedIntermediateInputSmoothness))) {
            md->coSimulation.hasRecommendedIntermediateInputSmoothness = 1;
            if (fmi3_xml_parse_attr_as_int32(context, elmID, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_recommendedIntermediateInputSmoothness), 0,
                    &md->coSimulation.recommendedIntermediateInputSmoothness, 0))
            {
                return -1;
            }
...
int fmi3_xml_handle_DefaultExperiment(fmi3_xml_parser_context_t *context, const char* data) {
    if(!data) {
        ...
        md->defaultExperiment.startTimeDefined  = fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_startTime));
        md->defaultExperiment.stopTimeDefined   = fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_stopTime));
        md->defaultExperiment.toleranceDefined  = fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_tolerance));
        md->defaultExperiment.stepSizeDefined   = fmi3_xml_is_attr_defined(context, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_stepSize));
