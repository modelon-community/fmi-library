...
#define fmi3_xml_scheme_ContinuousStateDerivatives          {fmi3_xml_elmID_none,       fmi3_xml_elmID_ModelStructure,              1,       0}
#define fmi3_xml_scheme_ContinuousStateDerivativeUnknown    {fmi3_xml_elmID_none,       fmi3_xml_scheme_ContinuousStateDerivatives, 0,       1}
