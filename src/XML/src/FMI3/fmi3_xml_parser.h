 ...
 */
void fmi3_xml_parse_attr_error(fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, const char* attrStr);

int fmi3_xml_parse_attr_as_string (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, jm_vector(char)* field);
int fmi3_xml_parse_attr_as_enum   (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, unsigned int*    field, unsigned int   defaultVal, jm_name_ID_map_t* nameMap);
int fmi3_xml_parse_attr_as_bool   (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, bool*            field, bool           defaultVal);
int fmi3_xml_parse_attr_as_boolean(fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, unsigned int*    field, unsigned int   defaultVal);
int fmi3_xml_parse_attr_as_intXX  (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, void*            field, void*          defaultVal, const fmi3_xml_primitive_type_t* primType);
int fmi3_xml_parse_attr_as_int32  (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, fmi3_int32_t*    field, fmi3_int32_t   defaultVal);
int fmi3_xml_parse_attr_as_uint64 (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, fmi3_uint64_t*   field, fmi3_uint64_t  defaultVal);
int fmi3_xml_parse_attr_as_uint32 (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, fmi3_uint32_t*   field, fmi3_uint32_t  defaultVal);
int fmi3_xml_parse_attr_as_floatXX(fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, void*            field, void*          defaultVal, const fmi3_xml_primitive_type_t* primType);
int fmi3_xml_parse_attr_as_float64(fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, fmi3_float64_t*  field, fmi3_float64_t defaultVal);
int fmi3_xml_parse_attr_as_float32(fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, fmi3_float32_t*  field, fmi3_float32_t defaultVal);
int fmi3_xml_parse_attr_as_sizet  (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, size_t*          field, size_t*        defaultVal);
int fmi3_xml_parse_attr_as_array  (fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, void** arrPtr, size_t* arrSize, jm_string str, const fmi3_xml_primitive_type_t* primType);

int fmi3_xml_parse_attr_valueref_list(fmi3_xml_parser_context_t* context, fmi3_xml_elm_enu_t elmID, const fmi3_xml_attr_union_t attrID, int required, jm_vector(fmi3_value_reference_t)* vrs);
