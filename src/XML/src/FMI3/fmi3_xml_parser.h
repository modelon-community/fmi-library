...
int fmi3_xml_parse_attr_as_string_exists (fmi3_xml_parser_context_t* context, fmi3_xml_elm_t elmID, const fmi3_xml_attr_t attrID, int required, int* exists, jm_vector(char)* field);
