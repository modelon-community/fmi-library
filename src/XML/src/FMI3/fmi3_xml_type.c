...
fmi3_xml_float_type_props_t* fmi3_xml_parse_float_type_properties(fmi3_xml_parser_context_t* context,
        fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* fallbackType, const fmi3_xml_primitive_type_t* primType)
{
    jm_named_ptr named, *pnamed;
    fmi3_xml_model_description_t* md = context->modelDescription;
...
int fmi3_xml_handle_FloatType(fmi3_xml_parser_context_t* context, const char* data, fmi3_xml_modelDescription_elm_enu_t elmID,
...
int fmi3_xml_handle_IntXXType(fmi3_xml_parser_context_t *context, const char* data, fmi3_xml_modelDescription_elm_enu_t elemID,
...
fmi3_xml_binary_type_props_t* fmi3_xml_parse_binary_type_properties(fmi3_xml_parser_context_t* context,
        fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* fallbackType)
{
...
fmi3_xml_variable_type_base_t* fmi3_parse_declared_type_attr(fmi3_xml_parser_context_t* context,
        fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* defaultType)
{
