...
typedef struct fmi3_xml_clock_type_props_t {
    ...
    // not all properties have defaults
    fmi3_boolean_t hasPriority;
    fmi3_boolean_t hasIntervalDecimal;
    fmi3_boolean_t hasResolution;
    fmi3_boolean_t hasIntervalCounter;

    // actual properties
    fmi3_boolean_t canBeDeactivated;
    fmi3_boolean_t supportsFraction;
    fmi3_interval_variability_enu_t intervalVariability; // required
...
fmi3_xml_float_type_props_t* fmi3_xml_parse_float_type_properties(fmi3_xml_parser_context_t* context, fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* fallbackType, const fmi3_xml_primitive_type_t* primType);
fmi3_xml_int_type_props_t* fmi3_xml_parse_intXX_type_properties(fmi3_xml_parser_context_t* context, fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* fallbackType, const fmi3_xml_primitive_type_t* primType);
fmi3_xml_binary_type_props_t* fmi3_xml_parse_binary_type_properties(fmi3_xml_parser_context_t* context, fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* fallbackType);
fmi3_xml_clock_type_props_t* fmi3_xml_parse_clock_type_properties(fmi3_xml_parser_context_t* context, fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* fallbackType);

fmi3_xml_variable_type_base_t* fmi3_parse_declared_type_attr(fmi3_xml_parser_context_t *context, fmi3_xml_modelDescription_elm_enu_t elmID, fmi3_xml_variable_type_base_t* defaultType);
