...
#define FMI3_PARSE_SI_BASE_UNIT_ENU(c) \
    fmi3_xml_parse_attr_as_int32(context, fmi3_xml_elmID_BaseUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_ ## c), 0, &(unit->SI_base_unit_exp[fmi3_SI_base_unit_ ## c]), 0) ||
            ret =
                FMI3_SI_BASE_UNITS(FMI3_PARSE_SI_BASE_UNIT_ENU) 
                /* <xs:attribute name="factor" type="xs:double" default="1"/> */
                fmi3_xml_parse_attr_as_float64(context, fmi3_xml_elmID_BaseUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_factor), 0, &unit->factor, 1) ||
                /* <xs:attribute name="offset" type="xs:double" default="0"/> */
                fmi3_xml_parse_attr_as_float64(context, fmi3_xml_elmID_BaseUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_offset), 0, &unit->offset, 0);
...
int fmi3_xml_handle_Unit(fmi3_xml_parser_context_t *context, const char* data) {
    if (!data) {
            ...
            if ( 
                ...
                fmi3_xml_parse_attr_as_string(context, fmi3_xml_elmID_BaseUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_name), 1, buf) ||
...
int fmi3_xml_handle_DisplayUnit(fmi3_xml_parser_context_t *context, const char* data) {
    if (!data) {
            ...
            /*  <xs:attribute name="name" type="xs:normalizedString" use="required"/> */
            ret = fmi3_xml_parse_attr_as_string(context, fmi3_xml_elmID_DisplayUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_name), 1, buf);
            if (ret) return ret;
            ...
            ret = 
                /* <xs:attribute name="factor" type="xs:double" default="1"/> */
                fmi3_xml_parse_attr_as_float64(context, fmi3_xml_elmID_DisplayUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_factor), 0, &dispUnit->factor, 1) ||
                /* <xs:attribute name="offset" type="xs:double" default="0"/> */
                fmi3_xml_parse_attr_as_float64(context, fmi3_xml_elmID_DisplayUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_offset), 0, &dispUnit->offset, 0) || 
                /* <xs:attribute name="inverse" type="xs:boolean" default="false"/> */
                fmi3_xml_parse_attr_as_boolean(context, fmi3_xml_elmID_DisplayUnit, FMI3_MODELDESCRIPTION_ATTR(fmi_attr_id_inverse), 0, &dispUnit->inverse, 0);
